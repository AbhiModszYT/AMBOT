...
from AMBOT.helpers.pasters import telegraph_paste
...
async def get_anilist(qdb, page):
    ...
    chnl = "[AbhiModszYT](https://t.me/AbhiModszYT_Return)"
    idm = data.get("id")
    ...
    title_img = f"{idm}.jpg"
    logo = "https://telegra.ph/file/9470b838234d9535b0f82.jpg"
    descr = ""
...
async def get_manga(qdb, page):
    ...
    finals_ += f"\n       **<\>** [AbhiModszYT](https://t.me/AbhiModszYT_Return/115)"
    banner_ = requests.get(banner)
    open(f"{idm}.jpg", "wb").write(banner_.content)
    pic = f"{idm}.jpg"
    return (
