...
from AMBOT.DB.gvar_sql import gvarstat
...
if Config.BOT_USERNAME and tbot:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            if a:
                ...
                help_pic = "https://telegra.ph/file/423a5a5a1f136a2258b76.mp4"
            ...
            alive_msg = gvarstat("ALIVE_MSG") or "»»» <b>𝗣𝗺 𝗣𝗿𝗼𝘁𝗲𝗰𝘁𝗲𝗿 𝗔𝗠𝗕𝗢𝗧 ιѕ σиℓιиє</b> «««"
            ...
            if a:
                ...
                PIC = "https://telegra.ph/file/97f26ac4769caf1f846ff.mp4"
            ...
            if a and a == "DISABLE":
                ...
                PIC = "https://telegra.ph/file/9470b838234d9535b0f82.jpg"
            if PIC and PIC.endswith((".jpg", ".png")):
                result = builder.photo(
                    file=PIC,
                    text=HELL_FIRST,
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚡ 𝗣𝗺 𝗣𝗿𝗼𝘁𝗲𝗰𝘁𝗲𝗿 𝗔𝗠𝗕𝗢𝗧 ⚡**",
                buttons=[
                    [Button.url("AMBOT", "https://t.me/AbhiModszYT_Return")],
                    [Button.url("AMBOT Repo", "https://github.com/AbhiModszYT/BOT")],
                ],
            )
            ...
            result = builder.article(
                "@AbhiModszYT_Return",
                text="""**Hey! This is [AbhiModszYT](https://t.me/AbhiModszYT_Return) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        Button.url("• Updates •", "https://t.me/AbhiModszYT_Return"),
                        Button.url("• Chat •", "https://t.me/AM_YTSupport"),
                    ],
                    [
                        Button.url("• Bots •", "https://t.me/AbhiModszYT_Return/115"),
                        Button.url("• Docs •", "https://hellbot.tech"),
                    ],
                    [
                        Button.url("◈ AMBOTs ◈", "https://t.me/AbhiModszYT_Return/115"),
                    ],
                ],
                link_preview=False,
            )
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            reply_popup = "🔰 This is AMBOT PM Security to keep away unwanted retards from spamming PM !!"
    ...
    async def reopn(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.answer("Hello! This help menu is not for you, you can make yourself a AMBOT and use your bot. Go to @AM_YTBOTT for more info.", cache_time=0, alert=True)
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.edit(
                f"**🎭 Closed AMBOT's help menu**\n\n**Bot Of:**  {hell_mention}\n\n        [©️ AbhiModszYT ™️]({chnl_link})",
                buttons=veriler,
                link_preview=False,
            )
        else:
    ...
    async def send(event):
        ...
        _, _, hell_mention = await client_id(event, event.query.user_id)
        omk = f"**• Plugin name ≈** `{plugin}`\n**• Uploaded by ≈** {hell_mention}\n\n⚡ **[ʟɛɢɛռɖaʀʏ ᴀғ AMBOT]({chnl_link})** ⚡"
        the_plugin_file = "./AMBOT/plugins/{}.py".format(plugin.lower())
    ...
    async def page(event):
        ...
        if event.query.user_id in auth:
            ...
            return await event.answer(
                "Hello! This help menu is not for you, you can make yourself a AMBOT and use your bot. Go to @AM_YTBOT for more info.",
                cache_time=0,
                alert=True,
            )
    ...
    async def Information(event):
        ...
        if event.query.user_id in auth:
            ...
            return await event.answer(
                "Hello! This help menu is not for you, you can make yourself a AMBOT and use your bot. Go to @AM_YTBOTT for more info.",
                cache_time=0,
                alert=True,
            )
