...
async def _(event):
    ...
    OUTPUT = f"**Files in AMBOT DOWNLOADS Folder:**\n"
...
CmdHelp("managers").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your AMBOT server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of AMBOT repo."
).add_command(
    "ls_saved", None, "Gives the list of all files in Saved directory of your AMBOT server"
).add_command(
