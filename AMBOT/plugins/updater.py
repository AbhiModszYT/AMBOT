...
hellbot_info = "https://raw.githubusercontent.com/abab12123/AMBOT/master/hellbot-info.json"
...
async def hell_info(hellbot_info):
    ...
    _version = infos["AMBOT-INFO"]["version"]
    _release = infos["AMBOT-INFO"]["release-date"]
    _branch = infos["AMBOT-INFO"]["branch"]
    _author = infos["AMBOT-INFO"]["author"]
    _coauthor = infos["AMBOT-INFO"]["co-author"]
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        await event.edit(f"**Your AMBOT Is UpToDate**\n\n**Version:**  __{hellbot_version}__\n**Oɯɳҽɾ:**  {hell_mention}")
    else:
