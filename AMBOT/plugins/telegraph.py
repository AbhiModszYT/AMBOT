...
async def _(event):
    ...
    title = None
    auth = "[ AbhiModszYT ]"
    url = "https://t.me/AbhiModszYT_Return"
...
CmdHelp("telegraph").add_command(
    ...
    "tgm", "<reply to a text> <title|author|authorlink>", "Makes a telegraph page of replied content using html parser."
).add_info(
