...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await hell.edit(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [AMBOT](https://t.me/AM_YTBOTT) __to release your account__😏",
                link_preview=False,
            )
        else:
            jnl = (
        ...
        mention = "`Warning!! User 𝙂𝘽𝘼𝙉𝙉𝙀𝘿 By AMBOT...\nReason: Not Given `"
